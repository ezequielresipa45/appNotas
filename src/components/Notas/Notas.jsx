...
export default function Notas({ children, elemento, deleteElemento, setvalueInput }) {
  ...
  const removeItems = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        array.splice(deleteElemento, 1);
        setvalueInput(array);

        Swal.fire(
          'Eliminado!',
          'Su nota ah sido eliminada.',
          'success'
        )
      }
    })
  ...
  return (
    ...
    <div className='container-children-notas' style={{
      backgroundColor: isActive ? '#4dd063' : '#ec4040'
    }}>
      <p>
        {children}
      </p>
